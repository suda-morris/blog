...
- **设计实现通用序列收发器驱动框架**
  ...
  *event-driven, OOP, IR, encoder*
  ...
  - RMT 驱动详见 [GitHub 项目地址](https://github.com/espressif/esp-idf/tree/master/components/driver/rmt)
...
- **BSP 软件包**
  ...
  *BSP, Interface Segregation Principle*
  ...
  - 定义并实现智能灯带 [led-strip](https://components.espressif.com/component/espressif/led_strip) 设备的操作接口
  ...
  - 模拟 1-Wire 总线驱动和设备驱动 [onewire_bus](https://components.espressif.com/components/espressif/onewire_bus)
