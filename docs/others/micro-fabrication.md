...
## MOSFET多晶硅删的刻蚀
![MOSFET多晶硅删的刻蚀](http://i.imgur.com/fHsTbdE.png)

## TSV（through silicon via）刻蚀
![TSV刻蚀](http://i.imgur.com/7CFMDkg.png)
...
6. 在氧化过程中将杂质引入，热扩散过程中伴随着Si的氧化
	...
	3. 掺杂P使用P2O5
	4. 掺杂As使用As2O3
7. H,Li,Na,K,Ar等I，VIII族元素在Si的扩散属于**间隙扩散**，间隙扩散适用于原子半径小的元素。
...
2. 工艺流程
	...
	5. 电镀金属Cu
	6. CMP抛光
![大马士革工艺](http://i.imgur.com/DQA98JU.png)
...
11. 硅化物自对准的作用
	1. 减小源漏接触电阻
	2. 减小栅极串联电阻
![Salicide后的CMOS器件](http://i.imgur.com/avHEO8z.png)
...
## CMOS集成电路的工艺集成
![CMOS集成电路工艺集成](http://i.imgur.com/swGgvvs.png)
1. CMOS IC的基本工艺模块
...
2. 一般CMOS工艺采用100晶向的硅
![CMOS加工步骤](http://i.imgur.com/IBB3aJj.png)
3. CMOS加工步骤
	...
	9. 制作钝化层
	10. I/O引出Pad
![Halo注入](http://i.imgur.com/7HcTYkt.png)
![形成多层金属互联](http://i.imgur.com/62NsBsK.png)

## 双极性集成电路的工艺集成
![双极集成电路](http://i.imgur.com/P2fWqyU.png)
1. 优势：高速，驱动能力强
2. 缺点：功耗大，集成度差
3. 工艺
	1. 制作埋层
...
![FinFET器件结构](http://i.imgur.com/z313zxt.png)
...
3. 相比单阱工艺，双阱工艺的优势：NMOS和PMOS能够单独做优化。但是双阱工艺占用面积更大，工艺更复杂
...
## 自对准BJT工艺
![高性能BJT结构](http://i.imgur.com/ua0pGfz.png)
![自对准BJT工艺](http://i.imgur.com/rG85e9z.png)
1. 特点：
	1. 利用多晶硅做发射极，提高了器件性能
	2. 埋层集电极
	3. 自对准多晶硅基极
...
## 短沟道器件结构
![短沟道器件结构](http://i.imgur.com/7aAjDdU.png)
...
3. 金属栅工艺流程
![金属栅制备流程1](http://i.imgur.com/1cYBrSt.png)
![金属栅制备流程2](http://i.imgur.com/h0K4joj.png)
	1. 标准的STI隔离，双阱和沟道的掺杂
	2. ALD一层high-k介质膜
